...
function showprint(newsid) {
	   	 printWindow = window.open('/sources/print.php?newsid='+newsid,"","top=5,left=10,width=750,height=600,scrollbars"); printWindow.resizeTo(750,600); printWindow.focus();
}
...
function popupImage(src, note, title, css, border) {                                                                     
         ...
         doc.write('<div align="center" style="font-size:10pt;">');
         ...
         doc.write('  window.resizeTo(imgW + 8 +' + border*2 +', imgH + 26 +' + border*2 +');');       
...
function showhide(id) {
         ...
         if (dom){
             if (els.display == "none") {
                 els.display = "";
                 window.status="Mở form phản hồi";
             } else {
                 els.display = "none";
                 window.status="Đóng form phản hồi";
             }
         } else if (ns4){
             if (els.display == "show") {
                 els.display = "hide";
