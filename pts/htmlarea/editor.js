...
//    ['fontstyle'],
    ...
    ['HorizontalRule','Createlink','InsertImage','InsertTable','InsertMedia','InsertVideo','InsertFlash','custom2','separator'],
...
this.btnList = {
    ...
    "insertmedia":    ['InsertMedia',          'Insert Media',       'editor_action(this.id)',  'insert_media.gif'],    
    "insertvideo":    ['InsertVideo',          'Insert Flash Video', 'editor_action(this.id)',  'insert_video.gif'],    
    "insertflash":    ['InsertFlash',          'Insert Flash',       'editor_action(this.id)',  'insert_flash.gif'],            
...
function editor_action(button_id) {
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert media
    else if (cmdID.toLowerCase() == 'insertmedia'){
      showModalDialog(_editor_url + "popups/insert_media.html?"+objname,window,"resizable: yes; help: no; status: no; scroll: no; ");
    }

    // insert video
    else if (cmdID.toLowerCase() == 'insertvideo'){
      showModalDialog(_editor_url + "popups/insert_video.html?"+objname,window,"resizable: yes; help: no; status: no; scroll: no; ");
    }

    // insert flash
    else if (cmdID.toLowerCase() == 'insertflash'){
      showModalDialog(_editor_url + "popups/insert_flash.html?"+objname,window,"resizable: yes; help: no; status: no; scroll: no; ");
    }
