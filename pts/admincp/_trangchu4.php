...
class func_logo{
      ...
      function Get_Sub($cid,$n,$did=-1){
        ...
        function do_Edit(){
                 ...
                 $data['f_tittle'] = "Edit Banner Trang chu 4";
                 if ( (isset($_POST['btnEdit'])) ) {
                       ...
                       if (empty($data['err'])) {
                           ...
                           $err = "Edit Banner Trang chu 4 Successfull";
                       }
                 }
                 ...
                 } else $this->output .= $this->html_ann("Banner Trang chu 4 not found !");
        }
        ...
        function do_Manage(){
                 ...
                 $query = $DB->query("SELECT * FROM ".$conf['perfix']."banner WHERE vitri='trangchu4'");
                 ...
                 for ($i=1; $i<$num_pages+1; $i++ ) {
                      ...
                      else $nav.="[<a href='?act=trangchu4&sub=manage&p={$i}'>$i</a>] ";
                 }
                 $nav .= "</div></center>";
                 $list = "";
                 $stt=0;
                 $query = $DB->query("SELECT * FROM ".$conf['perfix']."banner WHERE vitri='trangchu4' ORDER BY logo_order LIMIT $start,$n");
                 ...
                 $nd['tittle'] = "Manage Banner Trang chu 4 (300.XXX Pixel)";
                 $nd['nd'] = $list;
                 $nd['num'] = $stt+2;
                ...
                return<<<EOF
                        ...
                        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                             ...
                             <form action="?act=trangchu4&sub=edit&id={$data['l_id']}" method="post" enctype="multipart/form-data" name="add_pic" id="add_pic"  onSubmit="return checkform(this);">
                               <table width="100%" border="0" cellspacing="2" cellpadding="2" align=center>
                                  <tr>
                                      <td colspan="3" align="center"><font color="red">{$data['err']}</font></td>
                                  </tr>
                                  <tr>
                                      <td align="right">Banner Trang chu 4 Title  : </td>
                                  ...
                                  <tr>
                                      <td align="right">Banner Trang chu 4 Image : </td>
                                      <td align="left" colspan="2"><input name="chk_upload" type="radio" value="0" checked> Insert Banner Trang chu 4 URL&nbsp;
                                  ...
                                  <tr>
                                      <td align="right">Banner Trang chu 4 Link : </td>
       ...
       function html_nav($data){
                return<<<EOF
                        ...
                        <br><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                           ...
                           <tr>
                              <td bgcolor="#FFFFFF" class="main_table" align=center>
                              <form action="?act=trangchu4&sub=del" method="post" name="manage" id="manage">
                                 <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                      <td width="5%" class="row_tittle">Delete</td>
                                      <td width="5%" class="row_tittle">Order</td>
                                      <td width="25%" class="row_tittle">Banner Trang chu 4 Title</td>
                                      <td width="25%" class="row_tittle">Banner Trang chu 4 Images</td>
                                      <td width="32%" class="row_tittle">Banner Trang chu 4 Link</td>
                                   ...
                                   <tr>
                                      ...
                                      <td colspan=5 class="row_tittle" align=left><input type="submit" name="btnOrder" value="Edit Order"> <input type="submit" name="btnDel" value="Delete Seleted Banner Trang chu 4"> <input type="button" OnClick="window.location='?act=logoman'" value="Add New Banner Trang chu 4"></td>
                                   </tr>
                                 </table>
                              </form></td>
                           </tr>
         ...
         function html_row($data){
                  return<<<EOF
                          <tr>
                              ...
                              <td class="row" align=left><a href="?act=trangchu4&sub=edit&id={$data['l_id']}"><b>{$data['title']}</b>&nbsp;</a><br>Location: {$data['location']}</td>
                              <td class="row">{$data['l_img']}</td>
                              <td class="row">{$data['l_link']}</td>
                              <td class="row">
                                  <a href="?act=trangchu4&sub=edit&id={$data['l_id']}"><img src="images/edit.gif" width="22" height="22" alt="Edit Banner"></a>&nbsp;
                                  <a href="?act=trangchu4&sub=del&id={$data['l_id']}"><img src="images/delete.gif" width="22" height="22" alt="Delete Banner"></a>
                              </td>
                          </tr>
EOF;
       }
