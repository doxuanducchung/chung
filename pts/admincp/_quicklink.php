...
class func_logo{
      ...
      function Get_Sub($cid,$n,$did=-1){
        ...
        function do_Edit(){
                 ...
                 if ( (isset($_POST['btnEdit'])) ) {
                       ...
                       if (empty($data['err'])) {
                           ...
                           $err = "Edit Quick Link Successfull";
                       }
                 }
                 ...
                 if ($data=$DB->fetch_row($query)) {
                     ...
                     if ($data['type']=="swf"){
                         $data[html_img] ='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="200" height="130">
                                         <param name="movie" value="'.$src.'"><param name="quality" value="high">
                                         <embed src="'.$src.'" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="200" height="130"></embed>
                                         </object>';
                     } else
                 ...
                 } else $this->output .= $this->html_ann("Quick Link not found !");
        }
        ...
        function do_Manage(){
                 ...
                 $query = $DB->query("SELECT * FROM ".$conf['perfix']."banner WHERE vitri='quick'");
                 ...
                 for ($i=1; $i<$num_pages+1; $i++ ) {
                      ...
                      else $nav.="[<a href='?act=quicklink&sub=manage&p={$i}'>$i</a>] ";
                 }
                 $nav .= "</div></center>";
                 $list = "";
                 $stt=0;
                 $query = $DB->query("SELECT * FROM ".$conf['perfix']."banner WHERE vitri='quick' ORDER BY logo_order LIMIT $start,$n");
                 ...
                 $nd['tittle'] = "Manage Quick Link (200.XXX Pixel)";
                 $nd['nd'] = $list;
                 $nd['num'] = $stt+2;
                ...
                return<<<EOF
                        ...
                        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                             ...
                             <form action="?act=quicklink&sub=edit&id={$data['l_id']}" method="post" enctype="multipart/form-data" name="add_pic" id="add_pic"  onSubmit="return checkform(this);">
                               <table width="100%" border="0" cellspacing="2" cellpadding="2" align=center>
                                  <tr>
                                      <td colspan="3" align="center"><font color="red">{$data['err']}</font></td>
                                  </tr>
                                  <tr>
                                      <td align="right">Quick Link Title  : </td>
                                  ...
                                  <tr>
                                      <td align="right">Quick Link Image : </td>
                                      <td align="left" colspan="2"><input name="chk_upload" type="radio" value="0" checked> Insert Quick Link URL &nbsp;
                                          <input name="l_url" type="text" size="53" maxlength="250" value="{$data['l_url']}"><br>
                                          <input name="chk_upload" type="radio" value="1"> Upload Picture &nbsp;
                                          <input name="image" type="file" id="image" size="46" maxlength="250">
                                      </td>
                                  </tr>
                                  <tr>
                                      <td align="right">Quick Link Link : </td>
       ...
       function html_nav($data){
                return<<<EOF
                        ...
                        <br><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                           ...
                           <tr>
                              <td bgcolor="#FFFFFF" class="main_table" align=center>
                              <form action="?act=quicklink&sub=del" method="post" name="manage" id="manage">
                                 <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                      <td width="5%" class="row_tittle">Delete</td>
                                      <td width="5%" class="row_tittle">Order</td>
                                      <td width="25%" class="row_tittle">Quick Link Title</td>
                                      <td width="25%" class="row_tittle">Quick Link Images</td>
                                      <td width="32%" class="row_tittle">Quick Link Link</td>
                                   ...
                                   <tr>
                                      ...
                                      <td colspan=5 class="row_tittle" align=left><input type="submit" name="btnOrder" value="Edit Order"> <input type="submit" name="btnDel" value="Delete Seleted Quick Link"> <input type="button" OnClick="window.location='?act=logoman'" value="Add New Quick Link"></td>
                                   </tr>
                                 </table>
                              </form></td>
                           </tr>
         ...
         function html_row($data){
                  return<<<EOF
                          <tr>
                              ...
                              <td class="row" align=left><a href="?act=quicklink&sub=edit&id={$data['l_id']}"><b>{$data['title']}</b>&nbsp;</a><br>Location: {$data['location']}</td>
                              <td class="row">{$data['l_img']}</td>
                              <td class="row">{$data['l_link']}</td>
                              <td class="row">
                                  <a href="?act=quicklink&sub=edit&id={$data['l_id']}"><img src="images/edit.gif" width="22" height="22" alt="Edit Banner"></a>&nbsp;
                                  <a href="?act=quicklink&sub=del&id={$data['l_id']}"><img src="images/delete.gif" width="22" height="22" alt="Delete Banner"></a>
                              </td>
                          </tr>
EOF;
       }
