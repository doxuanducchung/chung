<?
if ($conf['display_mostviewbox'] == 'yes') {
?>
...
<?php
 $sql1 = "select * from ".$conf['perfix']."news where isdisplay!=0 order by viewnum DESC LIMIT 0,5";
...
<a href="<?=$linknews11?>"><?=$title11?><br><i>(<?=$viewnum?>: View)</i></a></div>
   <?
   }
   ?>
